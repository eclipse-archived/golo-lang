...
http://en.wikipedia.org/wiki/Trait_%28computer_programming%29[_traits_], or
http://en.wikipedia.org/wiki/Mixin[_mixin_],
...
The validity of the application is not checked at compile time. Thus
[source,golo]
----
