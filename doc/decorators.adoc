...
The module link:{golodoc}/gololang/Decorators.html[`gololang.Decorators`] provide two
...
link:{golodoc}/gololang/Decorators.html#withContext_context[`gololang.Decorators.withContext`]
standard decorator. This decorator take a context, such as the one returned by
link:{golodoc}/gololang/Decorators.html#defaultContext_[`gololang.Decorators.defaultContext`]
function.
