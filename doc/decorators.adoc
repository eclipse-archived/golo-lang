...
being “function” (more precisely a link:{javadoc}/gololang/FunctionReference[`gololang.FunctionReference`]).
...
NOTE: A more refined version of this `curry` decorator is available in the link:{golodoc}/gololang/Functions#curry_1[`gololang.Functions`] standard module
...
link:{golodoc}/gololang/Decorators.html[`gololang.Decorators`].
...
<<deco_principles,Principles and syntax>> section for an example.
...
The module link:{golodoc}/gololang/Decorators.html[`gololang.Decorators`] provides two
...
link:{golodoc}/gololang/Decorators.html[`gololang.Decorators`] to ease the creation
of checkers:
...
The full set of standard checkers is documented in the
link:{golodoc}/gololang/Decorators[generated _golodoc_].
...
link:{golodoc}/gololang/Decorators.html[`gololang.Decorators`] module, presented
here as an example:
...
link:{golodoc}/gololang/Decorators.html#withContext_1[`gololang.Decorators::withContext`]
standard decorator. This decorator take a context, such as the one returned by
link:{golodoc}/gololang/Decorators.html#defaultContext_0[`gololang.Decorators::defaultContext`]
function.
...
The context returned by link:{golodoc}/gololang/Decorators#defaultContext_0[`gololang.Decorators::defaultContext`] is a void one, that
...
[source,golo]
----
include::{samples-dir}/context-decorator.golo[lines=8..-1]
----
